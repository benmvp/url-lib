...
describe('formatQuery', () => {
  ...
  it('ignores null or undefined propery values', () => {
    // eslint-disable-next-line no-undefined
    const queryString = formatQuery({param1: undefined, param2: null, param3: 'hello'})
  ...
  it('formats multiple query params correctly', () => {
    const queryString = formatQuery({param1Name: 'param1Value', param2Name: 'param2Value', param3Name: 'param3Value'})
  ...
  it('coerces non string property values to strings', () => {
    ...
    expect(queryString).toEqual('p1=true&p2=false&p3=42&p4=42&p5=NaN&p6=Infinity&p7=hello&p8=hello&p9=hello&p10=1%2C2%2C3%2C4')
  })
  ...
  it('uses the last param object when multiple have the same property key', () => {
    const queryString = formatQuery([{p1: 'obj1', p2: 'obj1', p3: 'obj1'}, {p2: 'obj2', p3: 'obj2'}, {p3: 'obj3'}])
