...
describe('formatUrl', () => {
  ...
  it('returns the same URL with query string when called with a URL with query string', () => {
    const url = formatUrl('http://www.benmvp.com?param1Name=param1Value&param2Name=param2Value')

    expect(url).toEqual('http://www.benmvp.com?param1Name=param1Value&param2Name=param2Value')
  })
  ...
  it('correctly handles passing an empty URL, but with a query params object', () => {
    ...
    expect(url).toEqual('?param1Name=param1Value&param2Name=param2Value&param3Name=param3Value')
  })
  ...
  it('correctly handles passing an non-empty URL (without query string) with a query params object', () => {
    ...
    expect(url).toEqual('http://www.benmvp.com/search?category=holiday&type=all&results=20')
  })
  ...
  it('correctly handles various different types of values in params object', () => {
    ...
    expect(url).toEqual('http://www.benmvp.com?p1=true&p2=false&p3=42&p4=42&p5=NaN&p6=Infinity&p7=hello&p8=hello&p9=hello&p10=1%2C2%2C3%2C4')
  })
  ...
  it('correctly handles param name & values that need to be URI encoded', () => {
    ...
    expect(url).toEqual('http://www.benmvp.com?param1=%60%40%23%24%25%5E%26%2B%3D%5B%5D%7B%7D%7C%5C%3A%3B%22%3C%3E%2C%3F%2F%20&%60%40%23%24%25%5E%26%2B%3D%5B%5D%7B%7D%7C%5C%3A%3B%22%3C%3E%2C%3F%2F%20=hello')
  })
  ...
  it('correctly merges query params object into a URL that already has a query string', () => {
    ...
    expect(url).toEqual('http://www.benmvp.com/search?sort=popular&results=100&pg=1&category=holiday&type=all')
  })
  ...
  it('correctly handles URL with an array of query params objects', () => {
    ...
    expect(url).toEqual('http://www.benmvp.com?param1Name=param1Value&param2Name=param2Value&param3Name=param3Value')
  })
